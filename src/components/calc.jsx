import React from 'C:/Users/NAVER/AppData/Local/Microsoft/TypeScript/2.9/node_modules/@types/react';
...
class CalculatorKeyC extends React.Component {
  render() {
    const { onPress, className, ...props } = this.props
    
    return (
      <PointTarget onPoint={onPress}>
        <button className={`calc-button calculator-key ${className}`} {...props}/>
      </PointTarget>
    )
  }
}
